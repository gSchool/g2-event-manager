...
describe Registration do
  it 'can filter by attendance type' do
    event_i_own = Event.create!(name: 'GFY', description: 'Foo', date: 2.months.from_now, location: 'Denver', capacity:1, category: 'Birthday')
    event_i_attend = Event.create!(name: 'FYG', description: 'Bar', date: 2.months.from_now, location: 'Denver', capacity:1, category: 'Birthday')
    event_i_created = Event.create!(name: 'YFG', description: 'Baz', date: 2.months.from_now, location: 'Denver', capacity:1, category: 'Birthday')
